"""Validate one C0 v2.2 collection job without interpreting its outcomes."""
...
def validate_job(
    *,
    ...
    result_contract_pass = all(
        (
            result.get("protocol") == "RIST-C0-v2.2-SCIENTIFIC-JOB-EVIDENCE-v1",
    ...
    return {
        "protocol": "RIST-C0-v2.2-SCIENTIFIC-JOB-VALIDATION-v1",
        "job_id": job_id,
        "family": job["family"],
        "split": split,
