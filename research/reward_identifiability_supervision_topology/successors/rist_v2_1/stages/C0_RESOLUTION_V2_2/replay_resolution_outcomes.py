"""Recompute C0 v2.2 strict outcomes from frozen tasks and raw responses."""
...
def _load_evaluator():
    spec = importlib.util.spec_from_file_location("rist_c0_v2_2_resolution_evaluator", EVALUATOR_PATH)
    module = importlib.util.module_from_spec(spec)
    if spec.loader is None:
        raise RuntimeError("C0 v2.2 evaluator is unavailable")
