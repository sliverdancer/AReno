"""Validate one RIST C0 v4 collection job without using outcome values."""
...
JOB_PROTOCOL = "RIST-C0-v4.0-SCIENTIFIC-JOB-EVIDENCE-v1"
...
def validate_job(
    *,
    ...
    return {
        "protocol": "RIST-C0-v4.0-SCIENTIFIC-JOB-VALIDATION-v1",
        "job_id": job_id,
        "family": job["family"],
        "split": split,
