"""Build one split-scoped v4 C0 manifest without crossing its access boundary."""
...
PROTOCOL = "RIST-C0-v4.0-STAGE-MANIFEST-v1"
...
def build_manifest(
    *,
    ...
    if pool.get("protocol") != "RIST-C0-v4.0-FRESH-POOL-v1":
        raise ValueError("wrong v4 pool protocol")
